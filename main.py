...
parser.add_argument('--selected_dataset', default='CHBMIT', type=str,
...
if args.experiment_description == 'default':
    experiment_description = args.selected_dataset
...
# Trainer
Trainer(model, frequency_model, temporal_contr_model, frequency_contr_model, c_model, model_optimizer, frequency_model_optimizer, temporal_contr_optimizer, frequency_contr_optimizer, classification_optimizer, train_dl, valid_dl, test_dl, device, logger, configs, experiment_log_dir, training_mode)

if training_mode != "self_supervised":
    # Testing
    outs = model_evaluate(model, frequency_model, temporal_contr_model, frequency_contr_model, c_model, test_dl, configs, device, training_mode)
